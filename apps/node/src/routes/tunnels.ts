 ...
 * (`apps/node/CLAUDE.md` rule 4). The one thing it owns outright is the `ownerToken`: minted here,
 ...
 * (`apps/node/CLAUDE.md` § Gotchas). Every caller above goes through a checker that normalizes.
 */
