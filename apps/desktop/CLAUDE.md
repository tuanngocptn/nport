...
src/ipc/             thin wrappers over the generated bindings — health.ts only, so far
src-tauri/src/       main.rs lib.rs events.rs
...
(src-tauri/src/      commands.rs tray.rs state.rs)
```
